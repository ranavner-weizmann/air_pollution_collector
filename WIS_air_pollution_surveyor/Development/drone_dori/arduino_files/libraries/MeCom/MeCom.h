...
#define MeCom_LDD_Mon_AnodeVoltage(Address, Value, Cmd)                               MeCom_ParValuef(Address, 1004, 1, Value, Cmd)
#define MeCom_LDD_Mon_CathodeVoltage(Address, Value, Cmd)                             MeCom_ParValuef(Address, 1005, 1, Value, Cmd)
#define MeCom_LDD_Mon_PhotoDiode(Address, Value, Cmd)                             MeCom_ParValuef(Address, 1501, 1, Value, Cmd)
